...
<!-- HP2R_CURRENT_RELEASE=v0.1.0-rc.4 -->

Current release: `v0.1.0-rc.4` is a release candidate. It has host-side build
...
```sh
gh release download v0.1.0-rc.4 -R shayne/hyperpixel2r-kms -D dist/v0.1.0-rc.4
cd dist/v0.1.0-rc.4
