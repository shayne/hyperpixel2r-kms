...
<!-- HP2R_CURRENT_RELEASE=v0.1.0-rc.13 -->

Current release: `v0.1.0-rc.13` is a release candidate. It has host-side build
...
```sh
gh release download v0.1.0-rc.13 -R shayne/hyperpixel2r-kms -D dist/v0.1.0-rc.13
cd dist/v0.1.0-rc.13
