...
docker run --rm \
  ...
  --env HP2R_FIXTURE_LEGACY_ACCEPTED="${HP2R_FIXTURE_LEGACY_ACCEPTED:-}" \
  --env HP2R_FIXTURE_LEGACY_BACKLIGHT_INITIAL="${HP2R_FIXTURE_LEGACY_BACKLIGHT_INITIAL:-}" \
  --env HP2R_FIXTURE_LEGACY_BACKLIGHT_DRIFT="${HP2R_FIXTURE_LEGACY_BACKLIGHT_DRIFT:-}" \
  --env HP2R_FIXTURE_LEGACY_POST_AUTH_BACKLIGHT_DRIFT="${HP2R_FIXTURE_LEGACY_POST_AUTH_BACKLIGHT_DRIFT:-}" \
  --env HP2R_FIXTURE_FORGE_STAGE_BACKLIGHT_AUTHORITY="${HP2R_FIXTURE_FORGE_STAGE_BACKLIGHT_AUTHORITY:-}" \
  --env HP2R_FIXTURE_AUTHORIZATION_TUPLE_SHAPE="${HP2R_FIXTURE_AUTHORIZATION_TUPLE_SHAPE:-}" \
  "$image" \
